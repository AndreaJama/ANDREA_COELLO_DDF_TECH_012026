...
Para o desenvolvimento do case, foi utilizada como base principal o conjunto de dados públicos da [NYC Taxi & Limousine Commission (TLC)](https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.page), base oficial que disponibiliza milhões de registros de viagens realizadas na cidade de Nova York.
